...
```bash
# macbook pro
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v1.2.2/xctl-v1.2.2-darwin-amd64.tar.gz > /tmp/xctl.tar.gz

# macbook air
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v1.2.2/xctl-v1.2.2-darwin-arm64.tar.gz > /tmp/xctl.tar.gz
```
...
```bash
sudo mv /tmp/xctl-v1.2.2-darwin-amd64 /usr/local/bin/xctl

or

sudo mv /tmp/xctl-v1.2.2-darwin-arm64 /usr/local/bin/xctl
...
```bash
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v1.2.2/xctl-v1.2.2-linux-amd64.tar.gz > /tmp/xctl.tar.gz
```
...
```bash
sudo mv /tmp/xctl-v1.2.2-linux-amd64 /usr/local/bin/xctl
