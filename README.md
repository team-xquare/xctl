...
```bash
# macbook pro
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v0.2.8/xctl-v0.2.8-darwin-amd64.tar.gz > /tmp/xctl.tar.gz

# macbook air
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v0.2.8/xctl-v0.2.8-darwin-arm64.tar.gz > /tmp/xctl.tar.gz
```
...
```bash
sudo mv /tmp/xctl-v0.2.8-darwin-amd64 /usr/local/bin/xctl

or

sudo mv /tmp/xctl-v0.2.8-darwin-arm64 /usr/local/bin/xctl
...
```bash
sudo curl -L /tmp https://github.com/team-xquare/xctl/releases/download/v0.2.8/xctl-v0.2.8-linux-amd64.tar.gz > /tmp/xctl.tar.gz
```
...
```bash
sudo mv /tmp/xctl-v0.2.8-linux-amd64 /usr/local/bin/xctl
